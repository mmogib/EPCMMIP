# ============================================================================
# s30: Main benchmark for the harmonic-oscillator problem
# ============================================================================
#
# Goal:
#   Run the selected methods on the stored local harmonic-oscillator benchmark
#   dimensions / initial points and write the benchmark rows into the local DB.
#
# What this script reads:
#   - the local harmonic-oscillator problem definition
...
#   - results/optimal_control/harmonic_oscillator/logs/
...
if abspath(PROGRAM_FILE) == @__FILE__
    benchmark_main(HARMONIC_OSCILLATOR_SPEC)
end
