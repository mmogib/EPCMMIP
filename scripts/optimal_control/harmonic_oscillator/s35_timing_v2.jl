# External monitoring-free timing pass for definitive harmonic-oscillator OC.
...
if abspath(PROGRAM_FILE) == @__FILE__
    oc_timing_v2_main(HARMONIC_OSCILLATOR_SPEC,
                      "optimal_control_harmonic_oscillator")
end
